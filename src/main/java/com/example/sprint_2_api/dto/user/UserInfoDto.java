...
public class UserInfoDto implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        if (userInfoDto.getEmployeeBirthday() == null) {
            errors.rejectValue(BIRTHDAY_DTO, "", "Vui lòng nhập ngày sinh");
        }
//        else if (!FormatEmployee.check18YearsOld(String.valueOf(userInfoDto.getEmployeeBirthday()))) {
//            errors.rejectValue(BIRTHDAY_DTO, "", "Nhân viên chưa đủ 18 tuổi");
//        }
